...
Final Trial v1!
**Updates:
  1) All Use non-blocking codes and void stopStay() to allow immediately stops
      - Connect D2 Pin to Reset Pin to allow immediately stops for the stopStay function
  2) Create & Use void runMotors() and void startDraw() to simplify drawing commands
...
**Additional Drawing Commands for Testing:
    "A" - Draw a Star (Use chatgpt to modify based on Vic's example)
    "B" - Draw a Heart  (Use chatgpt to modify based on Vic's example)
*/
      ...
      case '8':
        {
          ...
          stopStay();    // lift pen / stop motion
          resetSpeed();  // restore default motor settings
          break;
        }  //exit case 0
